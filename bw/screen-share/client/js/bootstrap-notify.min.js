!(function(a) {
  var b = function(b, d) {
      if (
        ...
        (this.options = a.extend(!0, {}, a.fn.notify.defaults, d)),
        ...
        this.options.message || "" === this.$element.data("message")
  ...
  (b.prototype.show = function() {
    this.options.fadeOut.enabled &&
      this.$note
        .delay(this.options.fadeOut.delay || 3e3)
        .fadeOut("slow", a.proxy(c, this)),
